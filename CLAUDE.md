...
- TypeScript 5.x + Hono (API), React 18 (web), Drizzle ORM (DB), TanStack Query (data fetching), TanStack Router (v7), Arctic (Discord OAuth), Oslo (crypto), Midtrans SDK, Zod (validation), shadcn/ui (Radix UI + Tailwind) (007-payment-subscription-flow)
...
## Recent Changes
- 007-payment-subscription-flow: Added TypeScript 5.x + Hono (API), React 18 (web), Drizzle ORM (DB), TanStack Query (data fetching), TanStack Router (v7), Arctic (Discord OAuth), Oslo (crypto), Midtrans SDK, Zod (validation), shadcn/ui (Radix UI + Tailwind)
